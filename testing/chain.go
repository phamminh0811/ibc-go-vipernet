...
type TestChain struct {
	*testing.T
	...
	NextVals *comettypes.ValidatorSet
...
func NewTestChainWithValSet(t *testing.T, coord *Coordinator, chainID string, valSet *comettypes.ValidatorSet, signers map[string]comettypes.PrivValidator) *TestChain {
...
func NewTestChain(t *testing.T, coord *Coordinator, chainID string) *TestChain {
	...
	var (
		...
		validators         []*comettypes.Validator
		signersByAddress   = make(map[string]comettypes.PrivValidator, validatorsPerChain)
	)
	...
	for i := 0; i < validatorsPerChain; i++ {
		...
		validators = append(validators, comettypes.NewValidator(pubKey, 1))
...
func (chain *TestChain) NextBlock() {
	...
	chain.CurrentHeader = cometproto.Header{
...
func (chain *TestChain) GetValsAtHeight(height int64) (*comettypes.ValidatorSet, bool) {
	...
	return comettypes.NewValidatorSet(tmValidators), true
}
...
func (chain *TestChain) CreateTMClientHeader(chainID string, blockHeight int64, trustedHeight clienttypes.Height, timestamp time.Time, tmValSet, nextVals, tmTrustedVals *tmtypes.ValidatorSet, signers map[string]tmtypes.PrivValidator) *ibctm.Header {
	...
	commit, err := comettypes.MakeCommit(blockID, blockHeight, 1, voteSet, signerArr, timestamp)
	require.NoError(chain.T, err)
